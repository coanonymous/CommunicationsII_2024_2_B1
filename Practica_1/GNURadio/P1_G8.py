...
import P1_G8_epy_block_0 as epy_block_0  # embedded python block
import P1_G8_epy_block_1 as epy_block_1  # embedded python block
import P1_G8_epy_block_2 as epy_block_2  # embedded python block



from gnuradio import qtgui

class P1_G8(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "P1_grupo8", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("P1_grupo8")
        ...
        self.settings = Qt.QSettings("GNU Radio", "P1_G8")
        ...
        self.qtgui_number_sink_2.set_title("Salida Diff")
        ...
        self.qtgui_number_sink_1.set_title("Salida Mean")
        ...
        self.qtgui_number_sink_0.set_title("Salida Acum")
...
def main(top_block_cls=P1_G8, options=None):
