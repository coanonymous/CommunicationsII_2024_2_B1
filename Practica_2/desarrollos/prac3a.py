...
class prac3a(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.h = h = np.array([-1, 1, 0, 0, 3, -3, 2, 0, 1, -1])
        self.Sps = Sps = len(h)
        self.Rb = Rb = 32000
        ...
        self.interp_fir_filter_xxx_0 = filter.interp_fir_filter_fff(8, h)
        ...
        self.blocks_file_source_2 = blocks.file_source(gr.sizeof_char*1, '/home/comu2_grupob1/grupo8/sonido.wav', True, 0, 0)
        ...
        self.connect((self.blocks_file_source_2, 0), (self.blocks_unpack_k_bits_bb_1, 0))
